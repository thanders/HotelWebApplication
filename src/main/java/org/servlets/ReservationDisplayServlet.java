	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if(SessionUtils.getLoginedUser(request.getSession())!=null)
		{
			...
			RequestDispatcher dispatcher = request.getServletContext()
					.getRequestDispatcher("/views/starwoodDisplayView.jsp");
			...
			RequestDispatcher dispatcher = request.getServletContext()
					.getRequestDispatcher("/views/reservationDisplayView.jsp");
			dispatcher.forward(request, response);
		}
		...
		try {
			...
			if(resObj!=null) {
				...
				if(guestObj!=null) {
					...
					RequestDispatcher dispatcher = request.getServletContext()
							.getRequestDispatcher("/views/reservationConfirmView.jsp");
					dispatcher.forward(request, response);
